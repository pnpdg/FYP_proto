...
public class enterPassGallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enter_pass_gallery);

        db = FirebaseFirestore.getInstance();
        galleryPassText =  findViewById(R.id.enter_gallery_pass_text);
        enterBtn =  findViewById(R.id.enterGallery_btn);
            ...
            public void onClick(View view) {
                ...
                if(checkField(password)){
                    if(verifyPass(password, unhidePass) == true) {
                        startActivity(new Intent(enterPassGallery.this, Gallery.class));
        ...
        db.collection("Password").document(currentUser.getUid()).collection("Gallery Pass").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful() && !task.getResult().isEmpty()) {
                    ...
                    db.collection("Password").document(currentUser.getUid()).collection("Gallery Pass").document(documentID).get()
