...
public class ResetPassNotesFile extends AppCompatActivity {
    ...
    public void onBackPressed(){
        startActivity(new Intent(ResetPassNotesFile.this,MainActivity.class));
    }
    ...
    public void resetPass() {
        ...
        db.collection("notes").document(currentUser.getUid()).collection("my_notes").document(documentId).update(map).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
